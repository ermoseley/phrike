#!/usr/bin/env python3
"""
Dedalus script for 1D Sod shock tube problem with Chebyshev basis.
This script demonstrates solving the 1D Euler equations using Dedalus
with a Chebyshev spectral basis and 256 grid points.
...
To run:
    $ python3 dedalus_sod_chebyshev.py
"""
