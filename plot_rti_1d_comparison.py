#!/usr/bin/env python3
"""Plot initial and final conditions for 1D RTI test."""
...
def plot_rti_1d_comparison():
    """Plot initial vs final conditions for 1D RTI test."""
    
    # Load initial and final snapshots
    initial_path = "/Users/moseley/phrike/outputs/rti_1d_athena/snapshot_t0.000000.npz"
    final_path = "/Users/moseley/phrike/outputs/rti_1d_athena/snapshot_t2.000000.npz"
    ...
    try:
        ...
        if np.any(np.isnan(rho_initial)) or np.any(np.isnan(rho_final)):
            print("Warning: NaN values detected in density!")
        ...
        ax1.set_title('Density Profile: Initial vs Final')
        ...
        ax2.set_title('Velocity Profile: Initial vs Final')
        ...
        ax3.set_title('Pressure Profile: Initial vs Final')
        ...
        plt.suptitle('1D RTI Test: Initial vs Final Conditions', fontsize=14)
        
        # Save plot
        output_path = "/Users/moseley/phrike/outputs/rti_1d_athena/rti_1d_comparison.png"
